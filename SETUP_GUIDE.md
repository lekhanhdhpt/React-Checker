...
cd "e:\Đồ án tốt nghiệp\React-Checker"
...
python api/plagiarism_api.py
```

Server sẽ chạy tại: `http://localhost:5000`

**Lưu ý**: Đảm bảo các file model (`.pkl`, `.npy`, `.faiss`, `.json`) nằm trong thư mục gốc của project.
...
- Kiểm tra URL API trong CheckerPage.jsx: `http://localhost:5000/api/check-plagiarism`
...
├── src/
│   ├── components/
│   │   └── HighlightedText.jsx # Component hiển thị highlight
│   └── pages/
│       ├── CheckerPage.jsx      # Trang nhập văn bản
│       └── ResultsPage.jsx      # Trang kết quả
├── chunk_embeddings_normalized.npy
├── chunk_faiss_index.faiss
├── chunk_metadata.pkl
├── corpus_chunks.pkl
